...
function ClientEditPage({ params }) {
    ...
    const initialClient = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "ClientEditPage.useMemo[initialClient]": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            try {
                ...
                const list = JSON.parse(raw);
                return list.find({
                    "ClientEditPage.useMemo[initialClient]": (c)=>c.id === params.id
                }["ClientEditPage.useMemo[initialClient]"]) ?? null;
            } catch  {
                return null;
            }
        }
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "ClientEditPage.useEffect": ()=>{
            let mounted = true;
            ({
                "ClientEditPage.useEffect": async ()=>{
                    ...
                    const hit = all.find({
                        "ClientEditPage.useEffect.hit": (c)=>c.id === params.id
                    }["ClientEditPage.useEffect.hit"]);
...
_s(ClientEditPage, "58lhcc9px3ShySqc2W2NQNrLvjs=");
_c = ClientEditPage;
var _c;
...
//# sourceMappingURL=_88c43cd2._.js.map