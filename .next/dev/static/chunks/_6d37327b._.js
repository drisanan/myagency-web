...
function ClientViewPage({ params }) {
    ...
    const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "ClientViewPage.useQuery[q]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$clients$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClient"])(params.id)
        }["ClientViewPage.useQuery[q]"]
    });
...
_s(ClientViewPage, "5aALmIgJptN1trFjLSH6ywbGvzg=", false, function() {
    return [
...
_c = ClientViewPage;
var _c;
__turbopack_context__.k.register(_c, "ClientViewPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_6d37327b._.js.map