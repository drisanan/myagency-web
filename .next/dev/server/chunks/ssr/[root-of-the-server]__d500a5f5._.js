...
async function loginWithGHL(email, phone, accessCodeInput) {
    const API_BASE_URL = ("TURBOPACK compile-time value", "https://t4334hpi3h.execute-api.us-east-1.amazonaws.com") || process.env.API_BASE_URL;
    try {
        const endpoint = ("TURBOPACK compile-time truthy", 1) ? `${API_BASE_URL}/auth/ghl-login` : "TURBOPACK unreachable";
...
function Providers({ children }) {
    const [client] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(()=>new QueryClient());
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d500a5f5._.js.map