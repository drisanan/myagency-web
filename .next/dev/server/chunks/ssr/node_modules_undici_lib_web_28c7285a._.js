...
"[project]/node_modules/undici/lib/web/webidl/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { redirectStatusSet, referrerPolicyTokens, badPortsSet } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/constants.js [app-ssr] (ecmascript)");
...
const { ReadableStreamFrom, isValidHTTPToken, normalizedMethodRecordsBase } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { isUint8Array } = __turbopack_context__.r("[externals]/node:util/types [external] (node:util/types, cjs)");
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-ssr] (ecmascript)");
...
const { iteratorMixin } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-ssr] (ecmascript)");
...
const { bufferToLowerCasedHeaderName } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
...
const { ReadableStreamFrom, readableStreamClose, fullyReadBody, extractMimeType, utf8DecodeBytes } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-ssr] (ecmascript)");
const { FormData, setFormDataState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/formdata.js [app-ssr] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-ssr] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
...
const { createDeferredPromise } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/promise.js [app-ssr] (ecmascript)");
let random;
try {
...
const { extractBody, cloneBody, mixinBody, streamRegistry, bodyUnusable } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/body.js [app-ssr] (ecmascript)");
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
const nodeUtil = __turbopack_context__.r("[externals]/node:util [external] (node:util, cjs)");
const { kEnumerableProperty } = util;
const { isValidReasonPhrase, isCancelled, isAborted, serializeJavascriptValueToJSONString, isErrorLike, isomorphicEncode, environmentSettingsObject: relevantRealm } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-ssr] (ecmascript)");
...
/* globals AbortController */ const { extractBody, mixinBody, cloneBody, bodyUnusable } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/body.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/web/subresource-integrity/subresource-integrity.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
// https://github.com/Ethan-Arrowood/undici-fetch
const { makeNetworkError, makeAppropriateNetworkError, filterResponse, makeResponse, fromInnerResponse, getResponseState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/response.js [app-ssr] (ecmascript)");
const { HeadersList } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/headers.js [app-ssr] (ecmascript)");
const { Request, cloneRequest, getRequestDispatcher, getRequestState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/request.js [app-ssr] (ecmascript)");
const zlib = __turbopack_context__.r("[externals]/node:zlib [external] (node:zlib, cjs)");
...
const { addAbortListener, bufferToLowerCasedHeaderName } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
...
const { bytesMatch } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/subresource-integrity/subresource-integrity.js [app-ssr] (ecmascript)");
const { createDeferredPromise } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/promise.js [app-ssr] (ecmascript)");
...
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-ssr] (ecmascript)");
const { cloneResponse, fromInnerResponse, getResponseState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/response.js [app-ssr] (ecmascript)");
const { Request, fromInnerRequest, getRequestState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/request.js [app-ssr] (ecmascript)");
const { fetching } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/index.js [app-ssr] (ecmascript)");
const { urlIsHttpHttpsScheme, readAllBytes } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-ssr] (ecmascript)");
const { createDeferredPromise } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/promise.js [app-ssr] (ecmascript)");
/**
...
const { maxUnsigned16Bit, opcodes } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/constants.js [app-ssr] (ecmascript)");
...
const { parseExtensions, isClosed, isClosing, isEstablished, validateCloseCodeAndReason } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-ssr] (ecmascript)");
...
const { isValidStatusCode, isValidOpcode, websocketMessageReceived, utf8Decode, isControlFrame, isTextBinaryFrame, isContinuationFrame } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-ssr] (ecmascript)");
const { failWebsocketConnection } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/connection.js [app-ssr] (ecmascript)");
const { WebsocketFrameSend } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/frame.js [app-ssr] (ecmascript)");
...
const { staticPropertyDescriptors, states, sentCloseFrameState, sendHints, opcodes } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/constants.js [app-ssr] (ecmascript)");
const { isConnecting, isEstablished, isClosing, isClosed, isValidSubprotocol, fireEvent, utf8Decode, toArrayBuffer, getURLRecord } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-ssr] (ecmascript)");
const { establishWebSocketConnection, closeWebSocketConnection, failWebsocketConnection } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/connection.js [app-ssr] (ecmascript)");
const { ByteParser } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/receiver.js [app-ssr] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
const { getGlobalDispatcher } = __turbopack_context__.r("[project]/node_modules/undici/lib/global.js [app-ssr] (ecmascript)");
const { ErrorEvent, CloseEvent, createFastMessageEvent } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/events.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/web/websocket/stream/websocketerror.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-ssr] (ecmascript)");
const { validateCloseCodeAndReason } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-ssr] (ecmascript)");
const { kConstruct } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-ssr] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/web/websocket/stream/websocketstream.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { createDeferredPromise } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/promise.js [app-ssr] (ecmascript)");
const { environmentSettingsObject } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-ssr] (ecmascript)");
const { states, opcodes, sentCloseFrameState } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/constants.js [app-ssr] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/webidl/index.js [app-ssr] (ecmascript)");
const { getURLRecord, isValidSubprotocol, isEstablished, utf8Decode } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/util.js [app-ssr] (ecmascript)");
const { establishWebSocketConnection, failWebsocketConnection, closeWebSocketConnection } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/connection.js [app-ssr] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [app-ssr] (ecmascript)");
const { WebsocketFrameSend } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/frame.js [app-ssr] (ecmascript)");
const { ByteParser } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/receiver.js [app-ssr] (ecmascript)");
const { WebSocketError, createUnvalidatedWebSocketError } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/websocket/stream/websocketerror.js [app-ssr] (ecmascript)");
const { utf8DecodeBytes } = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/util.js [app-ssr] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
...
//# sourceMappingURL=node_modules_undici_lib_web_28c7285a._.js.map