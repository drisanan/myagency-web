...
"[project]/features/recruiter/searchService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const SearchParams = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    sport: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
...
async function searchAthletes(params) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$http$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["http"])(`/recruiter/search?${qs.toString()}`, {
        method: 'GET'
    });
}
}),
"[project]/features/recruiter/useRecruiterSearch.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$recruiter$2f$searchService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/recruiter/searchService.ts [app-ssr] (ecmascript)");
;
;
function useRecruiterSearch() {
    const query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$recruiter$2f$searchService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["searchAthletes"])({
                page: 1
            })
    });
    return query;
...
"[project]/features/recruiter/RecruiterSearchList.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$recruiter$2f$useRecruiterSearch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/recruiter/useRecruiterSearch.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function RecruiterSearchList({ onSelect }) {
    const { data, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$recruiter$2f$useRecruiterSearch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRecruiterSearch"])();
...
//# sourceMappingURL=_0bbd067c._.js.map