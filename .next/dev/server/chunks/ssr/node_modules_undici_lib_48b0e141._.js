...
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { isValidHTTPToken, isValidHeaderValue, isStream, destroy, isBuffer, isFormDataLike, isIterable, isBlobLike, serializePathWithQuery, assertRequestHandler, getServerName, normalizedMethodRecords, getProtocolFromUrlString } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/util/stats.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { kConnected, kPending, kRunning, kSize, kFree, kQueued } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [app-ssr] (ecmascript)");
class ClientStats {
    constructor(client){
...
"[project]/node_modules/undici/lib/util/promise.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/util/cache.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { safeHTTPMethods, pathHasQueryOrFragment } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
const { serializePathWithQuery } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
/**
...
"[project]/node_modules/undici/lib/util/date.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/handler/wrap-handler.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/handler/unwrap-handler.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { parseHeaders } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
const { InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-ssr] (ecmascript)");
...
const WrapHandler = __turbopack_context__.r("[project]/node_modules/undici/lib/handler/wrap-handler.js [app-ssr] (ecmascript)");
const { isDisturbed, parseRangeHeader, wrapRequestBody } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/handler/cache-handler.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
const { parseCacheControlHeader, parseVaryHeader, isEtagUsable } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/cache.js [app-ssr] (ecmascript)");
const { parseHttpDate } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/date.js [app-ssr] (ecmascript)");
function noop() {}
...
"[project]/node_modules/undici/lib/handler/cache-revalidation-handler.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { kDispatches, kDispatchKey, kDefaultHeaders, kDefaultTrailers, kContentLength, kMockDispatch, kIgnoreTrailingSlash } = __turbopack_context__.r("[project]/node_modules/undici/lib/mock/mock-symbols.js [app-ssr] (ecmascript)");
const { InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-ssr] (ecmascript)");
const { serializePathWithQuery } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
/**
...
const { kDispatches, kMockAgent, kClose, kOriginalClose, kOrigin, kOriginalDispatch, kConnected, kIgnoreTrailingSlash } = __turbopack_context__.r("[project]/node_modules/undici/lib/mock/mock-symbols.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/mock/mock-call-history.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { kMockCallHistoryAddLog } = __turbopack_context__.r("[project]/node_modules/undici/lib/mock/mock-symbols.js [app-ssr] (ecmascript)");
const { InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-ssr] (ecmascript)");
...
const { matchValue, normalizeSearchParams, buildAndValidateMockOptions } = __turbopack_context__.r("[project]/node_modules/undici/lib/mock/mock-utils.js [app-ssr] (ecmascript)");
...
const { MockCallHistory } = __turbopack_context__.r("[project]/node_modules/undici/lib/mock/mock-call-history.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/mock/snapshot-utils.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/mock/snapshot-recorder.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { InvalidArgumentError, UndiciError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-ssr] (ecmascript)");
const { hashId, isUrlExcludedFactory, normalizeHeaders, createHeaderFilters } = __turbopack_context__.r("[project]/node_modules/undici/lib/mock/snapshot-utils.js [app-ssr] (ecmascript)");
/**
...
"[project]/node_modules/undici/lib/mock/snapshot-agent.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const Agent = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/agent.js [app-ssr] (ecmascript)");
const MockAgent = __turbopack_context__.r("[project]/node_modules/undici/lib/mock/mock-agent.js [app-ssr] (ecmascript)");
const { SnapshotRecorder } = __turbopack_context__.r("[project]/node_modules/undici/lib/mock/snapshot-recorder.js [app-ssr] (ecmascript)");
const WrapHandler = __turbopack_context__.r("[project]/node_modules/undici/lib/handler/wrap-handler.js [app-ssr] (ecmascript)");
const { InvalidArgumentError, UndiciError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-ssr] (ecmascript)");
const { validateSnapshotMode } = __turbopack_context__.r("[project]/node_modules/undici/lib/mock/snapshot-utils.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/interceptor/response-error.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { ResponseError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/interceptor/dns.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const DecoratorHandler = __turbopack_context__.r("[project]/node_modules/undici/lib/handler/decorator-handler.js [app-ssr] (ecmascript)");
const { InvalidArgumentError, InformationalError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/undici/lib/interceptor/cache.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { Readable } = __turbopack_context__.r("[externals]/node:stream [external] (node:stream, cjs)");
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [app-ssr] (ecmascript)");
const CacheHandler = __turbopack_context__.r("[project]/node_modules/undici/lib/handler/cache-handler.js [app-ssr] (ecmascript)");
const MemoryCacheStore = __turbopack_context__.r("[project]/node_modules/undici/lib/cache/memory-cache-store.js [app-ssr] (ecmascript)");
const CacheRevalidationHandler = __turbopack_context__.r("[project]/node_modules/undici/lib/handler/cache-revalidation-handler.js [app-ssr] (ecmascript)");
const { assertCacheStore, assertCacheMethods, makeCacheKey, normalizeHeaders, parseCacheControlHeader } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/cache.js [app-ssr] (ecmascript)");
const { AbortError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [app-ssr] (ecmascript)");
/**
...
"[project]/node_modules/undici/lib/interceptor/decompress.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/cache/memory-cache-store.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { assertCacheKey, assertCacheValue } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/cache.js [app-ssr] (ecmascript)");
/**
...
"[project]/node_modules/undici/lib/cache/sqlite-cache-store.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
//# sourceMappingURL=node_modules_undici_lib_48b0e141._.js.map