        ...
        try {
            ...
            try {
                if (currentClient?.id) {
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mailStatus$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markMailed"])(currentClient.id, emailsToMark);
                }
            } catch  {}
        } catch (e) {
            console.error(e);
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                ...
                                children: (selectedList.items || []).map((it, idx)=>{
                                    const rowId = String(it.id || `List::${it.school || ''}::${it.email || ''}::${it.firstName || ''}-${it.lastName || ''}::${it.title || ''}::${idx}`);
                                    const mailed = currentClient?.id && it.email ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$mailStatus$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hasMailed"])(currentClient.id, it.email) : false;
...
//# sourceMappingURL=_63846b6d._.js.map