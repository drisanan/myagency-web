...
"[project]/app/api/forms/issue/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        const { agencyEmail } = await req.json();
        ...
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$forms$2f$token$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sign"])(payload);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: e?.message || 'Failed to issue form link'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a232778c._.js.map