...
export default function ClientProfilePage() {
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', position: 'relative', zIndex: 1 }}>
      ...
      <Typography variant="body1" sx={{ color: '#0A0A0A80', mb: 3 }}>
        Here&apos;s a snapshot of your profile. Coaches see this information when discovering athletes.
      </Typography>

      <ClientProfileView client={client} onEdit={() => setEditing(true)} />
    </Box>
  );
}
